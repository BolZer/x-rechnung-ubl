...
test(
    ...
    function (string $ublDocumentClass, string $pathToXmlExample) {
        ...
        $xmlFromUBLLegacyInvoice = Builder::create()->transformUblDocumentToXml($ublDocument);

        $formattedXmlFromUBLLegacyInvoice = $this->reformatXml($xmlFromUBLLegacyInvoice);

        $this->assertSame($xml, $formattedXmlFromUBLLegacyInvoice);
    }
)->with([
    [
        'ublDocumentClass' => UBLLegacyCreditNote::class,
