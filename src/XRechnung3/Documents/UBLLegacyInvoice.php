...
final class UBLLegacyInvoice  extends UBLAbstractDocument
{
    #[Type('string')]
    ...
    public function setDueDate(?string $dueDate): UBLLegacyInvoice
    {
    ...
    public function setInvoiceTypeCode(?int $invoiceTypeCode): UBLLegacyInvoice
    {
    ...
    public function setTaxPointDate(?string $taxPointDate): UBLLegacyInvoice
    {
    ...
    public function setContractDocumentReference(?DocumentReference $contractDocumentReference): UBLLegacyInvoice
    {
    ...
    public function setAdditionalDocumentReference(?DocumentReference $additionalDocumentReference): UBLLegacyInvoice
    {
    ...
    public function setProjectReference(?DocumentReference $projectReference): UBLLegacyInvoice
    {
    ...
    public function setInvoiceLine(?array $invoiceLine): UBLLegacyInvoice
    {
